...
class EditUserComponent extends Component {
    ...
    loadUser() {
        axios.get("http://localhost:8080/customer/"+window.localStorage.getItem("userId"))
             .then((res) => {
    ...
    saveUser = (e) => {
        ...
        axios.put("http://localhost:8080/customer"+"/" + window.localStorage.getItem("userId"), customer)
            .then(res => {
        ...
        return (
            <div>
                ...
                <form>
                    ...
                    <div className="form-group">
                        <label>Address :</label>
                        <input placeholder="First Name" name="address" className="form-control" value={this.state.address} onChange={this.onChange}/>
                    </div>
